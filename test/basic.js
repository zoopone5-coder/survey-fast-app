...
(async () => {
  ...
  try {
    ...
    const body = [
      ...
      `--${boundary}\r\nContent-Disposition: form-data; name="photoNames"\r\n\r\nSITE-1_1.jpg, SITE-1_2.jpg\r\n`,
    ...
    assert.equal(global.__row[11], 'SITE-1_1.jpg, SITE-1_2.jpg');
    assert.equal(global.__row[12], 'Need revisit');
